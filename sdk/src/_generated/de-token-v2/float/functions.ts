...
export interface GteArgs { a: TransactionObjectInput; b: TransactionObjectInput }

export function gte( tx: Transaction, args: GteArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::float::gte`, arguments: [ obj(tx, args.a), obj(tx, args.b) ], }) }
...
export interface LteArgs { a: TransactionObjectInput; b: TransactionObjectInput }

export function lte( tx: Transaction, args: LteArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::float::lte`, arguments: [ obj(tx, args.a), obj(tx, args.b) ], }) }
